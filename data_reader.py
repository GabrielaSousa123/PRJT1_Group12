...
class Instance:
    ...
    def process_data(self):
        ...
        #Garantir a formatação correta de listas para operadores e estações de trabalho   
...
def load_txt(filename):
    ...
    for line in lines:
        ...
        if line.startswith('['):
            if current_key:
                if len(data_buffer)==1: #Processa e guarda os dados da secção anterior no dicionário
